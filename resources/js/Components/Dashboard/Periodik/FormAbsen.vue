...
const getAbsen = async () => {
    await axios
        .get(
            route("dashboard.nilai.absen.index", {
                _query: {
...
const simpan = async () => {
    router.post(
        route("dashboard.nilai.absen.store", {
            _query: {
                siswaId: props.siswa.nisn,
                tapel: page.props.periode.tapel.kode,
                semester: page.props.periode.semester.kode,
...
<template>
    ...
    >
        ...
        <div
            class="dialog-body flex justify-center items-center p-4 border-t-2 border-slate-400 border-t"
        >
            <table width="100%">
                <tbody>
                    <tr>

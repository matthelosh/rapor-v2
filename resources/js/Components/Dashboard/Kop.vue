...
<template>
    ...
    >
        ...
        <div class="teks text-center font-serif col-span-6 print:col-span-8">
            <h3 class="uppercase font-bold text-lg print:text-[12pt]">
                Pemerintah Kabupaten Malang
            </h3>
            <h3 class="uppercase font-bold text-lg print:text[10pt]">
                Dinas Pendidikan dan Kebudayaan
            </h3>
            <h3 class="uppercase font-bold text print:text-[10pt]">
                Korwil Dinas Pendidikan Kecamatan
                {{ capitalize(sekolah.kecamatan) }}
            </h3>
            <h1 class="uppercase font-bold text-2xl print:text-[14pt]">
                {{ sekolah.nama }}
            </h1>

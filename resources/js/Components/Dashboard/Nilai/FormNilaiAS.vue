            ...
            <span class="uppercase">
                <span class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="text-sky-800 font-black">
                            {{
                                props.mapel.label
                                    ? props.mapel.label
            ...
            <el-skeleton :loading="loading" animated>
                <template #template>
                    ...
                    >
                        ...
                        <el-skeleton-item
                            variant="text"
                            style="width: 100px; height: 30px; margin: 0 5px"
                        />
                        <el-skeleton-item
                            variant="text"
                            style="width: 50%; height: 30px; margin: 0 5px"
                        />
                        <el-skeleton-item
                            variant="text"
                            style="width: 50px; height: 30px; margin: 0 5px"
                ...
                <template #default>
                    ...
                    >
                        ...
                        <el-table-column width="90">
                            <template #header>
                                <span class="cursor-pointer"> N. PAS </span>
                            </template>
                            <template #default="scope">
                                <el-input
                                    v-model="siswas[scope.$index].nilai"
                                    type="number"
                                    min="0"
                                    max="100"
                                    size="small"

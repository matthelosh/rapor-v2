    ...
    const jmlPG = computed(() => {
        return props.selectedAsesmen.soals.filter((soal) => soal.tipe == "pilihan_ganda")
            .length;
    });
    const jmlPGK = computed(() => {
        return props.selectedAsesmen.soals.filter((soal) => soal.tipe == "pilihan_ganda_kompleks")
            .length;
    });
                        ...
                        <div>
                            ...
                            <div class="cetak" v-else>
                                        ...
                                        <div class="soal">
                                            ...
                                            >
                                                ...
                                                <div v-if="soals.length > 0">
                                                        ...
                                                        >
                                                            <ul class="tes">
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <template v-for="(jawaban, j) in soal.jawabans.split('|')">
                                                                            <div class="flex">
                                                    ...
                                                    <div class="pilihan_ganda_kompleks">
                                                        <h1
                                                            class="font-bold text-lg mb-2 mt-8"
                                                        >
                                                            ...
                                                            <ul class="tes">
                                                                ...
                                                                >
                                                                    ...
                                                                    <span
                                                                        class="md:flex gap-6 ml-4"
                                                                    >
                                                                        <template v-for="( jawaban, j) in soal.jawabans.split('|')" :key="j">
                                                                            <div
                                ...
                                >
                                    ...
                                    <div class="pilihan_ganda_kompleks">
                                        <h3 class="font-bold">II. Pilihan Ganda Kompleks</h3>
                                        <div class="columns-6 p-2">
                                            <div
                                                v-for="(soal, s) in soals.filter(
                                                    (soal) =>
                                ...
                                >
                                    ...
                                    <h3
                                        class="text-center bg-slate-500 uppercase text-white py-2 font-bold mt-2"
                                    >
                                        Jawaban Pilihan Ganda Kompleks
                                    </h3>
                                    <p class="text-center">
                                        Beri tanda silang (X) pada pilihan jawaban
                                        yang benar (lebih dari satu)!

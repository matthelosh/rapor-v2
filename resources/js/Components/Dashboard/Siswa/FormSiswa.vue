...
const lebar = computed(() => {
    ...
    return width >= 1366 ? 'lg' : (width >= 1024 ? 'md' : width >= 768 ? 'sm' : 'xs')
})
...
<template>
    <el-dialog v-model="show" :width="lebar == 'xs' || lebar == 'sm' ? '100%' : '800px'" title="Formulir Data Siswa" @close="closeMe" draggable :fullscreen="lebar == 'xs' || lebar == 'sm'">
        <el-row :gutter="10">
                    ...
                    <el-row :gutter="6">
                        <el-col :span="14" :xs="24">
                            <el-form-item label="Tempat Lahir">
                                <el-input v-model="siswa.tempat_lahir" placeholder="Tempat Lahir Siswa"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="10" :xs="24">
                            <el-form-item label="Tanggal Lahir">
                                <el-date-picker v-model="siswa.tanggal_lahir" value-format="YYYY-MM-DD" placeholder="Tempat Lahir Siswa"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="6">
                        ...
                        <el-col :span="3" :xs="12">
                            <el-form-item label="RT">
                                <el-input v-model="siswa.rt" placeholder="RT"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="3" :xs="12">
                            <el-form-item label="RW">
                                <el-input v-model="siswa.rw" placeholder="RW"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="10" :xs="24">
                            <el-form-item label="Desa">
                                <el-input  v-model="siswa.desa" placeholder="Desa" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="4" :xs="24">
                            <el-form-item label="Kode Pos">
                                <el-input  v-model="siswa.kode_pos" placeholder="Kode Pos" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="8" :xs="24">
                            <el-form-item label="Kecamatan">
                                <el-input  v-model="siswa.kecamatan" placeholder="Kecamatan" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="6" :xs="24">
                            <el-form-item label="Kabupaten">
                                <el-input  v-model="siswa.kabupaten" placeholder="Kabupaten" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="6" :xs="24">
                            <el-form-item label="Provinsi">
                                <el-input  v-model="siswa.provinsi" placeholder="Provinsi" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="6">

...
<template>
    <el-card>
        ...
        <div class="cetak">
            <div
                class="p-10 shadow-lg print:shadow-none rounded w-[27cm] h-[21cm] mx-auto bg-cover bg-no-repeat relative"
                :class="`bg-[url('${bg}')]`"
            >
                <!-- <vue-qrcode value="Halo" class="absolute" /> -->
                <div
                    class="qr absolute p-3 bg-white rounded print:-left-[50px]"
                >
                    <QRCodeVue3
                        :height="100"
                        :width="100"
                        :value="
                            route('sertifikat.verify', {
                                _query: { nomor: sertifikat.nomor },
                            })
                        "
                    />
                </div>
                ...
                <h1
                    class="text-center text-4xl font-bold text-blue-900 mt-8 tracking-widest"
                >
                    SERTIFIKAT
                </h1>
                <h3
                    class="text-center text-lg font-bold p-2 bg-yellow-300 w-[40%] mx-auto"
                >
                    Nomor: {{ sertifikat.nomor }}
                </h3>
                <h3 class="text-center mt-6 text-lg">Diberikan Kepada:</h3>

                <h1 class="text-center text-4xl underline mt-4 font-black">
                    {{ sertifikat.penerima.nama }},
                    {{ sertifikat.penerima.gelar_belakang }}
                </h1>
                <p class="text-center text-2xl tracking-wide">
                    NIP. {{ sertifikat.penerima.nip }}
                </p>

                <h3
                    class="text-center text-xl p-2 bg-sky-200 w-[50%] mx-auto font-bold mt-4"
                >
                    {{ sertifikat.penerima.sekolahs[0].nama }}
                </h3>

                <p class="text-center w-[70%] mx-auto text-lg mt-6">
                ...
                <div class="grid grid-cols-6 gap-4 w-[80%] mx-auto mt-10">
                    <div class="ttd col-span-3">
                        ...
                        <p class="underline font-bold mt-20">
                            ABDUL MANAB, S. Pd., M.M.
                        </p>
                        <p>NIP.</p>
                    </div>
                    ...
                    <div class="ttd col-span-2">
                        ...
                        <p class="underline mt-20 font-bold uppercase">
                            {{ sertifikat.workshop.pelaksana }}
                        </p>
                        <p>NIP.</p>
                    </div>
                </div>

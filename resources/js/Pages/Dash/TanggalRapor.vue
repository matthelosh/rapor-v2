...
<template>
    ...
    <DashLayout>
        <template #header>
            <span class="uppercase">Tanggal Rapor </span>
        </template>
        <el-card>
            <template #header>
                <div class="card-header flex items-center justify-between">
                    <span
                        class="card-title font-bold text-slate-700 text-lg flex items-center"
                    >
        ...
        <div class="dialog-body">
            <el-form v-model="tanggal" label-position="top">
                ...
                <el-form-item label="Tipe Rapor">
                    <el-select
                        v-model="tanggal.tipe"
                        placeholder="Pilih Tipe Rapor"
                    >
                        <el-option
                            v-for="tipe in ['pts', 'pas']"
                            :key="tipe"
                            :value="tipe"

            ...
            <div class="w-full mt-4">
                ...
                <div class="sem-2">
                    ...
                    @if($rombel->tingkat == '6')
                            ...
                            @if(isset($catatan['is_tuntas']) && $catatan['is_tuntas'])
            ...
            <div class="ttd mt-8 w-full ">
                ...
                <div class="grid grid-cols-5 mt-4">
                    ...
                    <div class="col-span-3 text-center relative">
                        ...
                        <br>
                        <br>
                        <p class="font-bold underline "><span class="uppercase">{{$siswa->sekolah->ks->nama}}</span>, {{$siswa->sekolah->ks->gelar_belakang}}</p>

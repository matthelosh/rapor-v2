            ...
            <div class="ttd mt-4 w-full text-[0.7em]">
                ...
                <div class="grid grid-cols-3">
                    ...
                    <div class="col-span-1 text-center relative">
                        <p>Kepala Sekolah</p>
                        <img src="https://is3.cloudhost.id/alsya/public/images/ttd/{{ $siswa->sekolah->ks->nip }}.png" class="absolute max-h-[55px] left-[50%] -translate-x-[50%] rotate-4 z-0" onerror="this.onerror = null;this.src='{{ asset('img/no_ttd.png') }}'" />
                        <br>
                        <br>
                        <br>
                    ...
                    <div class="col-span-1 text-center relative">
                        <p>Wali Kelas</p>
                        <img src="https://is3.cloudhost.id/alsya/public/images/ttd/{{ $rombel->wali_kelas->nip }}.png" class="absolute max-h-[55px] left-[50%] -translate-x-[50%] rotate-4 z-0" onerror="this.onerror = null;this.src='{{ asset('img/no_ttd.png') }}'" />
                        <br>
                        <br>
                        <br>
